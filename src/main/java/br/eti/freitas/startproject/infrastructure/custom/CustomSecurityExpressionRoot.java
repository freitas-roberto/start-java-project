...
public class CustomSecurityExpressionRoot implements MethodSecurityExpressionOperations {
    ...
    private String defaultRolePrefix = SecurityConstant.SECURITY_JWT_DEFAULT_ROLE_PREFIX;
    ...
    public final boolean hasAnyRole(String... roles) {
    	LOG.info("CustomSecurityExpressionRoot.hasAnyRole: defaultRolePrefix={}, roles={}", defaultRolePrefix, roles);
